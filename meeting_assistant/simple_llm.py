...
parameters = {
    ...
    GenParams.MAX_NEW_TOKENS: 512,  # Limits the maximum number of tokens the model can generate in one response.
    GenParams.MIN_NEW_TOKENS: 1,
    GenParams.TEMPERATURE: 0.5,     # Controls the randomness of the model's output; lower values make responses more deterministic.
    GenParams.TOP_K: 50,
    GenParams.TOP_P: 1,
}
